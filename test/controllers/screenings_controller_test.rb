...
class ScreeningsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create screening" do
    assert_difference('Screening.count') do
      post screenings_url, params: { screening: { arena: @screening.arena, num_seats: @screening.num_seats, num_sold: @screening.num_sold, price: @screening.price, screening_date: @screening.screening_date, screening_time: @screening.screening_time } }
    end
  ...
  test "should update screening" do
    patch screening_url(@screening), params: { screening: { arena: @screening.arena, num_seats: @screening.num_seats, num_sold: @screening.num_sold, price: @screening.price, screening_date: @screening.screening_date, screening_time: @screening.screening_time } }
